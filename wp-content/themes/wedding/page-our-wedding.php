<?php /* Template Name: Our Wedding Template */ 
	get_header();
?>
                ...
                <div class="row">
                    ...
                    <section id="maincontent" class="nine columns positionleft">
                            ...
                            <section class="content">
                                ...
                                <img alt="" src=<?= get_template_directory_uri() . "/images/content/pic1.jpg"?> class="frame margin_right" /><img alt="" src=<?= get_template_directory_uri() . "/images/content/pic2.jpg"?> class="frame" />
                                </div>
                                ...
                                <div class="row story">
                                	<div class="one_half columns">
                                    	<img alt="" src=<?= get_template_directory_uri() . "/images/icons/icon1.png"?> class="circle alignleft" />
                                    ...
                                    <div class="one_half columns">
                                    	<img alt="" src=<?= get_template_directory_uri() . "/images/icons/icon2.png"?> class="circle alignleft" />
                                        <div class="indentleft">
                                	...
                                	<div class="one_half columns">
                                    	<img alt="" src=<?= get_template_directory_uri() . "/images/icons/icon3.png"?> class="circle alignleft" />
                                        <div class="indentleft">
                                	...
                                	<div class="one_half columns">
                                    	<img alt="" src=<?= get_template_directory_uri() . "/images/icons/icon4.png"?> class="circle alignleft" />
                                        <div class="indentleft">
                                      	<h3>Save the date</h3>
                                        <p>Sed vulputate, sem nec lobortis pharetra, ante eros bibendum leo, dictum consectetur metus mauris et lectus.</p>
                                        </div>
                    ...
                    <aside class="three columns">
                        ...
                        <ul>
                            ...
                            <li class="widget-container">
                                ...
                                <ul class="rp-widget">
                                    <li>
                                        <img src=<?= get_template_directory_uri() . "/images/content/small-img1.jpg"?> alt="" />
                                        <h3><a href="#">This is about our wedding event</a></h3>
                                        <span class="smalldate">April 27, 2012</span>
                                        <span class="clear"></span>
                                    </li>
                                    <li class="last">
                                        <img src=<?= get_template_directory_uri() . "/images/content/small-img2.jpg"?> alt="" />
